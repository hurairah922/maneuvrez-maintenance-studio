...
class ContactRevealComponent implements ComponentInterface {
	...
	public function get_label() {
		return __( 'Contact reveal', MMSM_TEXT_DOMAIN );
	}
	...
	public function get_settings_schema() {
		return array(
			array(
				'key'      => 'contact_label',
				'label'    => __( 'Contact label', MMSM_TEXT_DOMAIN ),
				'type'     => 'text',
				'default'  => 'Need help?',
				'required' => false,
			),
			array(
				'key'      => 'contact_message',
				'label'    => __( 'Contact message', MMSM_TEXT_DOMAIN ),
				'type'     => 'text',
			...
			array(
				'key'      => 'contact_email',
				'label'    => __( 'Contact email', MMSM_TEXT_DOMAIN ),
				'type'     => 'email',
				'default'  => '',
				'required' => false,
			),
